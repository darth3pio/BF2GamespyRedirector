...
namespace BF2GamespyRedirector
{
    ...
    public static class Redirector
    {
        ...
        public static readonly string[] GamespyHosts = {
                ...
                "eapusher.dice.se" // Main menu EA news?
            };
        ...
        private static void SetProviderIPAddress(ServiceProvider provider)
        {
            // Parse the IP Addresses of the Providers
            if (!Networking.TryGetIpAddress(provider.StatsAddress, out StatsServerAddress))
            {
                StatsServerAddress = null;
                throw new Exception("Unable to fetch the IPAddress for the Stats Server.");
            }
            else if (!Networking.TryGetIpAddress(provider.GamespyAddress, out GamespyServerAddress))
            {
                GamespyServerAddress = null;
                throw new Exception("Unable to fetch the IPAddress for the Gamespy Servers.");
            }
        }
